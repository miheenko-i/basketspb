...
export default function CampPage() {
  ...
  return <div id="top" className="camp-page">
    <div className="announcement">ЛЕТНИЙ ГОРОДСКОЙ ЛАГЕРЬ <span>Для новичков и любителей 10–18 лет</span></div>
    <SiteHeader camp/>
    <main id="main">

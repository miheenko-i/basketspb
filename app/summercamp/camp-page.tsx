...
export default function CampPage() {
  ...
  return <div id="top" className="camp-page">
    ...
    <main id="main">
      ...
      <section className="section camp-life" id="camp-life"><div className="section-heading"><div><h2>КАК ПРОХОДИЛ<br/>ЛАГЕРЬ В 2025 ГОДУ</h2></div><p>Не только тренируемся,<br/>но и весело проводим время.</p></div><CampGallery/></section>

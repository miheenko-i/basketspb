 ...
 return <div id="top" className="home-page">
  ...
  <main id="main">
   ...
   <section className="section programs" id="programs"><div className="section-heading"><div><h2>НАПРАВЛЕНИЯ</h2></div><p>Научиться мастерски играть в баскетбол или же виртуозно овладеть баскетбольным мячом?</p></div><div className="program-grid">
    <article className="program-card"><button className="program-media" onClick={()=>openBooking('Баскетбольные навыки')} aria-label="Баскетбол — записаться на пробное занятие"><img src="/basketspb/images/basketball.jpg" alt="Групповая тренировка по дриблингу" loading="lazy" width="1680" height="1120"/><span className="program-cta" aria-hidden="true"><span>Записаться на пробное занятие</span><ArrowUpRight size={22}/></span></button><div className="program-copy"><h3 className="program-title">БАСКЕТБОЛ</h3><p className="program-description">Постановка броска, дриблинг и финты. Развитие скорости, координации и выносливости. Общая физическая подготовка.</p></div></article>
    <article className="program-card freestyle-card"><button className="program-media" onClick={()=>openBooking('Баскетбольный фристайл')} aria-label="Баскетбольный фристайл — записаться на пробное занятие"><img src="/basketspb/images/freestyle.jpg" alt="Баскетбольный фристайлер выполняет трюк с мячом" loading="lazy" width="1680" height="1120"/><span className="program-cta" aria-hidden="true"><span>Записаться на пробное занятие</span><ArrowUpRight size={22}/></span></button><div className="program-copy"><h3 className="program-title">ФРИСТАЙЛ</h3><p className="program-description">Ловкость и выносливость, креативность и нестандартное мышление. Развитие физической силы, настойчивости и упорства.</p></div></article>

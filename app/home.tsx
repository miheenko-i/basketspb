 ...
 return <div id="top" className="home-page">
  ...
  <main id="main">
   ...
   <section className="section programs" id="programs"><div className="section-heading"><div><h2>НАПРАВЛЕНИЯ</h2></div><p>Научиться мастерски играть в баскетбол или же виртуозно овладеть баскетбольным мячом?</p></div><div className="program-grid">
    <article className="program-card"><button className="program-media" onClick={()=>openBooking('Баскетбольные навыки')} aria-label="Баскетбол — записать на пробное занятие"><img src="/basketspb/images/basketball.jpg" alt="Групповая тренировка по дриблингу" loading="lazy" width="1680" height="1120"/><span className="program-cta" aria-hidden="true"><span>Записать на пробное занятие</span><ArrowUpRight size={22}/></span></button><div className="program-copy"><h3 className="program-title">БАСКЕТБОЛ</h3><p className="program-description">Постановка броска, дриблинг и финты. Развитие скорости, координации и выносливости. Общая физическая подготовка.</p></div></article>
    <article className="program-card freestyle-card"><button className="program-media" onClick={()=>openBooking('Баскетбольный фристайл')} aria-label="Баскетбольный фристайл — записать на пробное занятие"><img src="/basketspb/images/freestyle.jpg" alt="Баскетбольный фристайлер выполняет трюк с мячом" loading="lazy" width="1680" height="1120"/><span className="program-cta" aria-hidden="true"><span>Записать на пробное занятие</span><ArrowUpRight size={22}/></span></button><div className="program-copy"><h3 className="program-title">ФРИСТАЙЛ</h3><p className="program-description">Ловкость и выносливость, креативность и нестандартное мышление. Развитие физической силы, настойчивости и упорства.</p></div></article>
   ...
   <section className="section growth-section" id="growth"><div className="section-heading"><h2>ПРОСТАЯ СИСТЕМА РОСТА<br/>ОТ НОВИЧКА ДО ЛЮБИТЕЛЯ</h2></div><ol className="growth-steps">
    <li><span className="growth-number" aria-hidden="true">01</span><h3>Групповые тренировки</h3><p>Получение и отработка базовых навыков баскетбола.</p></li>
    <li><span className="growth-number" aria-hidden="true">02</span><h3>Любительская команда</h3><p>Освоение простых взаимодействий в команде.</p></li>
    <li><span className="growth-number" aria-hidden="true">03</span><h3>Любительские лиги города</h3><p>Полное погружение в любительский баскетбол Санкт-Петербурга.</p></li>
